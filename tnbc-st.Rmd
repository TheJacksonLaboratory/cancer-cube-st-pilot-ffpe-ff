  ...
  llply(datasets, .parallel = FALSE,
        .fun = function(dataset) {
          ...
          if(!file.exists(rds.file)) {
            ...
            st.counts <- GetAssayData(obj, slot="counts")
...
# 3. Plot distribution of pops (across samples and pops)
# 4. Plot spatial distribution of pops
