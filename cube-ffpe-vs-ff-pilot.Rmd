...
filtered.objs <- 
  llply(datasets, 
        .fun = function(dataset) {
          ...
          obj <- create.Seurat.object(spaceranger_dirs, dataset,'filtered_feature_bc_matrix.h5', TRUE)
          obj
        })
...
unfiltered.objs <- 
  llply(datasets, 
        .fun = function(dataset) {
          ...
          obj <- create.Seurat.object(spaceranger_dirs, dataset,'raw_feature_bc_matrix.h5', FALSE)
          obj
        })
```
